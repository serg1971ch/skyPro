...
import ru.otus.jdbc.crm.DriverManagerDataSource;
...
// Работа с клиентом
        EntityClassMetaData<Client> entityClassMetaDataClient = (EntityClassMetaData<Client>) new EntityClassMetaDataImpl<>(Client.class);
