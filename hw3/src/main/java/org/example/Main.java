 ...
 */
        ...
        byte student2 = 27;
        byte student3 = 30;
        byte allStents = 23 + 27 + 30;
        byte allNotes = 80;
        int notesForPerStudent = allStents/allNotes;
...
Для объявления переменных не используйте тип var.
 */
        double performanceForONeMinute = (double) 19 /2;
        int performanceForTwentyMinutes = (int) (performanceForONeMinute*20);
        int performanceForDay = (int) (performanceForONeMinute*24*60);
 ...
 */
        byte allCans = 120;
        byte cansOfEachClassForWithePaint = 2;
        byte cansOfEachClassForBrownPaint = 4;
        byte classes = (byte) (allCans/(cansOfEachClassForWithePaint+cansOfEachClassForBrownPaint));
 ...
 */
        double mashaProfit = 74.536;
        double mashaYearOverCome = 8.832 ;
        double denProfit = 92.059 ;
        double denYearOverCome = 10.369;
        double kristyProfit = 83.853 ;
        double kristyYearOverCome = 7.623;
        System.out.println("Маша теперь получает" + mashaProfit + " рублей. Годовой доход вырос на " + mashaYearOverCome + " рублей");
        System.out.println("Денис теперь получает" + denProfit + " рублей. Годовой доход вырос на " + denYearOverCome + " рублей");
        System.out.println("Кристина теперь получает" + kristyProfit + " рублей. Годовой доход вырос на " + kristyYearOverCome + " рублей");
    }
}